...
void ordenarLista(Nodo *cabeza){
    ...
    do{
        intercambiado = false;
        puntero1 = cabeza;
        while(puntero1->sig != puntero2){
            //llevamos el elemento mayor al final de la lista
            if(puntero1->elem > puntero1->sig->elem){
                intercambiar(puntero1, puntero1->sig);
                intercambiado = true;
            }
